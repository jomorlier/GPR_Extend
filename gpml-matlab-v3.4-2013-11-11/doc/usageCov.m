% demonstrate usage of covariance functions - doesn't run (without
% commenting out failing fcns)
%
...
cca = {'covPPard',3}; hypcc = hypma; % compact support poly degree 3
cci = {'covPPiso',2}; hypcc = hypmi; % compact support poly degree 2
