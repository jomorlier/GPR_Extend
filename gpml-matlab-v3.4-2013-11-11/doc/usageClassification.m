% demonstrate usage of classification - fails while using likErf
%
% Copyright (c) by Carl Edward Rasmussen and Hannes Nickisch 2013-10-16.
clear all, close all

%% SAY WHICH CODE WE WISH TO EXERCISE - index of fxns used
id = [1,1]; % use Gauss/Exact
id = [1,5; 2,5]; % compare Laplace
...
lik_list = {'likGauss','likLogistic'};          % allowable likelihoods
